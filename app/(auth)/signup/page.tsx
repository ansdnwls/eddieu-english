      ...
      >
        ...
        <div className="mt-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
          ...
          <div className="text-xs text-green-700 dark:text-green-400 space-y-1">
            <div>테스트 계정을 빠르게 생성하려면 아래 정보를 사용하세요:</div>
            <div className="mt-2">
              <strong>일반:</strong> test@example.com / test123456
            </div>
            <div>
            ...
            <button
              ...
              className="mt-2 text-xs bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded transition-all"
            >
              일반 계정 자동 입력
            </button>
            <button
